...
func CodeToSlug(code int) string {
	...
	case 100:
		return ContinueSlug
	case 101:
		return SwitchingProtocolsSlug
	case 102:
		return ProcessingSlug
	case 200:
		return OkSlug
	case 201:
		return CreatedSlug
	case 202:
		return AcceptedSlug
	case 203:
		return NonAuthoritativeInformationSlug
	case 204:
		return NoContentSlug
	case 205:
		return ResetContentSlug
	case 206:
		return PartialContentSlug
	case 207:
		return MultiStatusSlug
	case 208:
		return AlreadyReportedSlug
	case 226:
		return ImUsedSlug
	case 300:
		return MultipleChoicesSlug
	case 301:
		return MovedPermanentlySlug
	case 302:
		return FoundSlug
	case 303:
		return SeeOtherSlug
	case 304:
		return NotModifiedSlug
	case 305:
		return UseProxySlug
	case 307:
		return TemporaryRedirectSlug
	case 308:
		return PermanentRedirectSlug
	case 400:
		return BadRequestSlug
	case 401:
		return UnauthorizedSlug
	case 402:
	...
	case 404:
		return NotFoundSlug
	case 405:
		return MethodNotAllowedSlug
	case 406:
		return NotAcceptableSlug
	case 407:
		return ProxyAuthenticationRequiredSlug
	case 408:
		return RequestTimeoutSlug
	case 409:
		return ConflictSlug
	case 410:
		return GoneSlug
	case 411:
		return LengthRequiredSlug
	case 412:
		return PreconditionFailedSlug
	case 413:
		return PayloadTooLargeSlug
	case 414:
		return RequestURITooLongSlug
	case 415:
		return UnsupportedMediaTypeSlug
	case 416:
		return RequestedRangeNotSatisfiableSlug
	case 417:
		return ExpectationFailedSlug
	case 418:
		return IMATeapotSlug
	case 421:
		return MisdirectedRequestSlug
	case 422:
		return UnprocessableEntitySlug
	case 423:
		return LockedSlug
	case 424:
		return FailedDependencySlug
	case 426:
		return UpgradeRequiredSlug
	case 428:
		return PreconditionRequiredSlug
	case 429:
		return TooManyRequestsSlug
	case 431:
		return RequestHeaderFieldsTooLargeSlug
	case 444:
		return ConnectionClosedWithoutResponseSlug
	case 451:
		return UnavailableForLegalReasonsSlug
	case 499:
		return ClientClosedRequestSlug
	case 500:
		return InternalServerErrorSlug
	case 501:
		return NotImplementedSlug
	case 502:
		return BadGatewaySlug
	case 503:
		return ServiceUnavailableSlug
	case 504:
		return GatewayTimeoutSlug
	case 505:
		return HTTPVersionNotSupportedSlug
	case 506:
		return VariantAlsoNegotiatesSlug
	case 507:
		return InsufficientStorageSlug
	case 508:
		return LoopDetectedSlug
	case 510:
		return NotExtendedSlug
	case 511:
		return NetworkAuthenticationRequiredSlug
	case 599:
		return NetworkConnectTimeoutErrorSlug
	}
